...
export const DataDiagnostics: React.FC<DataDiagnosticsProps> = ({
  ...
  return (
    <div className="w-full flex justify-end transition-all duration-300 ease-in-out">
      {!isExpanded ? (
        <button
          onClick={() => setIsExpanded(true)}
          className="bg-slate-900/65 border border-white/10 hover:border-blue-500/50 hover:bg-slate-800/80 p-3 rounded-full text-blue-400 shadow-lg hover:shadow-blue-500/20 transition-all duration-300 hover:scale-105 active:scale-95 backdrop-blur-md cursor-pointer flex items-center justify-center animate-fade-in"
          title="Show Data Diagnostics"
          aria-label="Show data loading and cache diagnostics"
        >
          <svg
            className="w-5 h-5"
            fill="none"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/5 pb-3">
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-1.5 -ml-1 text-blue-400 hover:bg-white/5 hover:text-blue-300 rounded-lg transition-colors cursor-pointer flex items-center justify-center"
                title="Hide Data Diagnostics"
                aria-label="Hide data loading and cache diagnostics"
              >
                <svg
